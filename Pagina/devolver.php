  ...
  <section class="main-conteiner">
    <form method="post" action="<?php echo $_SERVER["PHP_SELF"]; ?>" class="main">
      ...
      <div class="input-group input-group-sm mb-3">
        ...
        <input value="<?php echo $_POST['buscado']; ?>" name="item" required type="text" class="form-control" placeholder="¿Qué elemento devuelve?" aria-label="Username" aria-describedby="basic-addon1" title="nada de carácteres raros" pattern="^[0-9A-Za-záéíóúÁÉÍÓÚÑñ/s,._,-]+$">
      </div>
